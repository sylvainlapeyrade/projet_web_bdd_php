...
\newpage
    ...
    \clearpage
		...
		\subsubsection{Page gestion artiste}
            ...
            \begin{paragraphe}
                La gestion des artistes se fais donc maintenant avec 3 pages, une page de gestion, une page de formulaire et une page d'action.
            \end{paragraphe}
            ...
            \begin{paragraphe}
                \textbf{Page de gestion :} elle récupère toutes les entrées des artistes à l'aide de la fonction \emph{getListeArtiste()} pour les affichers dans un tableau.
            \end{paragraphe}

            \begin{center}
                \begin{tabular}{l | l}
                    \textbf{Si} clic sur le titre << Panneau administration >> & \textbf{Si} clic sur le bouton << Gestion artiste >> \\
                    \textbf{Alors} redirection vers adminAccueil.php. & \textbf{Alors} redirection vers gestionArtiste.php. \\ \\

                    \textbf{Si} clic sur le bouton << Ajouter artiste >> & \textbf{Si} clic sur le bouton << Modifier >> \\
                    \textbf{Alors} redirection vers formArtiste.php. & \textbf{Alors} redirection vers formArtiste.php. \\ \\
                \end{tabular}
            ...
            \begin{paragraphe}
                ...
                \textbf{Sinon} il s'agit de modifier un artiste. on récupère les données de l'artiste avec la fonction getArtiste(artiste).
            \end{paragraphe}
        ...
        \newpage
            ...
            \begin{center}
                \begin{tabular}{l | l}
                    ...
                    \textbf{Alors} effectuer l'action ajouterArtiste(artiste). & \textbf{Alors} effectue l'action modifierArtiste(artiste).
                \end{tabular}
            \end{center}
