    ...
    \subsection{Pages publiques}
		...
		\subsubsection{Page description artiste/groupe}
         ...
         \newpage
            ...
            \end{paragraphe}
            \image{0.35}{page_artiste_finale}{Pages publiques - Page artiste finale}

           \begin{paragraphe}
                Voici un autre exemple pour un groupe:
            \end{paragraphe}
            \image{0.35}{page_groupe_finale}{Pages publiques - Page groupe finale}
		...
		\subsubsection{Page description album/musique}
           ...
           \begin{paragraphe}
            ...
            \image{0.25}{page_album_non_connecter}{Mockup - Page album non connecté}

           \newpage

			\image{0.25}{page_album_connecter}{Mockup - Page album connecté}
            ...
            \end{paragraphe}
            \image{0.35}{page_album_deconnecte}{Pages publiques - Page album non connecté finale}
          ...
          \newpage
           ...
           \begin{paragraphe}
            ...
            \end{paragraphe}
            \image{0.35}{page_album_connecte}{Pages publiques - Page album connecté finale}
