    ...
    \clearpage
		...
		\subsubsection{Page gestion artiste}
			...
			\begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, le prénom et la date de naissance de l'artiste étant obligatoire. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, le prénom et la date de naissance de l'artiste étant obligatoire. Modifie ensuite les informations dans la base de données.
                \end{paragraphe}
    ...
    \clearpage
		...
		\subsubsection{Page gestion groupe}
			...
			\begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, la date de création du groupe sont obligatoire obligatoire. De plus il est obligatoire de sélectionner deux artistes au minimum. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, la date de création du groupe sont obligatoire obligatoire. De plus il est obligatoire de sélectionner deux artistes au minimum. Modifie ensuite les informations dans la base de données.
                \end{paragraphe}
    ...
    \newpage
		...
		\subsubsection{Page gestion album}
			...
			\begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, la date de création de l'album sont obligatoire. De plus il est obligatoire de sélectionner un artiste ou un groupe de musique au minimum. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, la date de création de l'album sont obligatoire. De plus il est obligatoire de sélectionner un artiste ou un groupe de musique au minimum. Modifie ensuite les informations dans la base de données.
                \end{paragraphe}
			...
			\begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Un numéro de piste pour la musique dans l'album est obligatoire. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Un numéro de piste pour la musique dans l'album est obligatoire. Modifie ensuite les informations dans la base de données.
                \end{paragraphe}
    ...
    \newpage
		...
		\subsubsection{Page gestion musique}
            ...
            \begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte.
	...
	\clearpage
		...
		\subsubsection{Page gestion récompense}
			...
			\begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom et la date de la récompense sont obligatoire. De plus il est obligatoire de sélectionner un artiste au minimum. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom et la date de la récompense sont obligatoire. De plus il est obligatoire de sélectionner un artiste au minimum. Modifie ensuite les informations dans la base de données.
                \end{paragraphe}
		...
		\subsubsection{Page gestion compte utilisateur}
			...
			\begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, le mot de passe et la vérification du mot de passe sont obligatoire. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
