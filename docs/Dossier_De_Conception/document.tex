...
\section{Charte graphique}
    ...
    \begin{paragraphe}
		...
		un bouton << connexion >>, un bouton << inscription >> si l'on n'est pas connecté.\\
		Nous avons, pendant le développement, pensé à ajouter un bouton << À propos >> renvoyant vers une page contenant des méta-information sur le site, comme
		le cadre de sa création, les noms de leurs auteurs et leurs contacts, un lien vers le github contenant le code source du site ou des vidéos de démonstration
		de l'utilisation su site.
...
\newpage
	...
	\begin{paragraphe}
		Une barre de recherche est également présente en dessous du bandeau du haut sur toutes les pages du site, hormis celles de connexion, inscription, de gestion de compte, d'administration et d'à propos.
		Elle permet de saisir des recherches d'artistes, d'albums, de groupes ou de morceaux de musique.
	\end{paragraphe}
    ...
    \begin{paragraphe}
       ...
       et démarquant distinctement les différentes lignes et colonnes du tableau par une bordure.
    \end{paragraphe}
...
\section{Présentation}
	\subsection{Disposition 1 (layout)}
        ...
        \begin{paragraphe}
            ...
            déplacé le bouton << accueil >> sur la droite et affiché à sa place le titre du site qui dirige vers l'accueil si l'on clique dessus.\\
            Nous avons également introduit la barre de recherche en dessous de ce bandeau pour la plupart des pages (Cf 2.Charte Graphique).
        \end{paragraphe}
	...
	\subsection{Disposition 2 (layout)}
        ...
        \begin{paragraphe}
            Le layout final obtenu est également très proche de ce que nous avions conceptualisé. Nous avons effectué les mêmes changements que pour la disposition 1.
            On remarque cependant que le bouton << deconnexion >> est bien présent à la place du bouton << Connexion >>.
        \end{paragraphe}
	...
	\subsection{Disposition 3 (layout)}
        ...
        \begin{paragraphe}
            Le layout final obtenu est également très proche de ce que nous avions conceptualisé. Nous avons effectué les mêmes changements que pour la disposition 1.
            On remarque cependant que le bouton << administration >> est bien présent en plus du bouton << Déconnexion >>.
        \end{paragraphe}
...
\section{Définition des pages}
        	...
        	\begin{paragraphe}
                ...
                De même certains ont été ajouté pour répondre aux fonctionnalités que nous n'avions pas conceptualisé au départ.
            \end{paragraphe}
            ...
            \begin{paragraphe}
                ...
                fonction, rangée dans une arborescence.
            \end{paragraphe}
...
\newpage
    ...
    \subsection{Pages publiques}
		...
		\subsubsection{Page accueil}
			...
			\begin{paragraphe}
                La barre de recherche a une place centrale sur la page d'accueil. Elle permet de saisir des recherches d’artistes, d’albums, de groupes ou de morceaux de musiques.
				En cliquant sur le bouton recherche, l'utilisateur sera dirigé vers une page affichant les résulats avec des liens redirigant vers une page dédiée pour chacun d'eux.
            ...
            \begin{paragraphe}
                Redirection vers la page \underline{recherche.php} qui traitera la requête soumise dans le formulaire de la barre de recherche.
			\end{paragraphe}
		...
		\subsubsection{Page résultat recherche}
            ...
            \begin{paragraphe}
                Nous avons cependant opté, lors du développement, sur un affichage sous forme de lignes qui nous semblait plus lisible sur les différentes plateformes.\\
                En voici un exemple:
            \end{paragraphe}
		...
		\subsubsection{Page description artiste/groupe}
            \begin{paragraphe}
                Les pages \underline{artiste.php} et \underline{groupe.php} font chacunes des requêtes sur la base de données sur les entités << Artiste >> ou << Groupe >>
                 en passant en paramètre le nom transmis par la page \underline{recherche.php}. Elles affichent alors le résultat.
            \end{paragraphe}
		...
		\subsubsection{Page description album/musique}
			...
			\begin{paragraphe}
                Les pages \underline{album.php} et \underline{musique.php} font chacunes des requêtes la base de données, sur les entités << Album >> ou << Musique >>
                 en passant en paramètre le nom transmis par la page resultat de recherche. Elles affichent alors le résultat renvoyé.
				Si un utilisateur non connecté souhaite rédiger un commentaire et donner une note à un album ou à une musique,
           ...
           \begin{paragraphe}
            ...
            \begin{paragraphe}
                Pour afficher les différentes métadonnées de l'artiste, groupe et de leur commentaires nous avons besoin des services suivant:
                \begin{itemize}
                        ...
                        \item getCommentaire(nom) pour obtenir les commentaires de la musique ou de l'album.
                \end{itemize}
            \end{paragraphe}
			...
			\begin{paragraphe}
				...
				\textbf{Alors} envoie le commentaire et la note à la base de données et affichage à l'écran le commentaire et la note visible par tout utilisateur du site.
			\end{paragraphe}
        ...
        \clearpage
			...
			\begin{paragraphe}
                Les pages finales d'album sont ici aussi très ressemblantes à celles de notre conception.
			\end{paragraphe}
	...
	\subsection{Pages utilisateurs}
      \begin{paragraphe}
		...
		\subsubsection{Page de connexion}
			...
			\begin{paragraphe}
				Cette page est accessible à tout utilisateur non connecté à l'application web.
			\end{paragraphe}
    ...
    \clearpage
		...
		\subsubsection{Page d'inscription}
           ...
           \begin{paragraphe}
			...
			\begin{paragraphe}
				\textbf{Si} l'action précédente a réussi \\
				\textbf{Alors} l'utilisateur est ensuite redirigé vers la page \underline{pageConnexion.php} avec le message : << votre compte a bien été enregistré >>. \\
				\textbf{Sinon} l'utilisateur reste sur la page avec un message d'erreur.
			\end{paragraphe}
    ...
    \clearpage
		...
		\subsubsection{Page de gestion compte utilisateur}
			...
			\begin{paragraphe}
				Après vérification par le biais d'une requête sur la base de données, la page affiche un message indiquant si toutes les données entrée sont valides et
				 que la modification à bien été effectuée. Ou, si certaines informations sont erronées, la nature de l'erreur et propose de remplir à nouveau le formulaire avec des valeurs conformes.
			\end{paragraphe}
			...
			\begin{paragraphe}
                Il faut vérifier que les deux mots de passes soient valides et identiques. \\
                Une fois cette vérification établie, la base de données est modifiée par la nouvelle valeur correspondant au nom de compte connecté.
			...
			\begin{paragraphe}
				Initalement, le formulaire est vide, il sera soumis à la page \underline{formUtilisateur.php} pour la vérification.
			\end{paragraphe}
        ...
        \newpage
            ...
            \begin{paragraphe}
               Au cours du développment, l'aspect et la logique de cette page a été conservé. Nous avons cependant ajouté une nouvelle fonctionnalité
            ...
            \begin{paragraphe}
                Cette page nous rapelle notre nom d'utilsateur et affiche deux boutons, l'un supprime le compte auquel nous somme connecté en transmettant une requête de suppression dans la
                base de données. Le second bouton renvoie l'utilisateur à au formulaire de modification de son mot de passe.
            \end{paragraphe}
	...
	\subsection{Pages d'administration}
        ...
        \begin{paragraphe}
            Dans la version une du dossier de conception, toutes les pages d'administrations été composées d'un grand nombre de formulaires et de boutons.
            ...
            Rendant ainsi les pages plus générique et modulaire en associant une page à une entité, simplifiant de facto l'utilisation.
        \end{paragraphe}
    
        \begin{paragraphe}
            Nous avons donc établie six catégories pour gérer les différentes entités de la base de données :
            \vspace{1em}
            \begin{itemize}
        ...
        \begin{paragraphe}
            Chaque page des six catégories est présente dans un dossier portant le nom de l'entité qu'il gère. \\
            De plus une page gestion, une page formulaire et une page action, pour chaque catégorie, permettent de distribué le code sur chaque catégorie
            pour une meilleure fonctionnalité et lisibilité.
        \end{paragraphe}

        \begin{paragraphe}
            \textbf{Les pages gestions} permettent de gérer les valeurs contenus dans la base de données, en les modifiant ou en les supprimant.
        \end{paragraphe}
        
        \begin{paragraphe}
            \textbf{Les pages formulaires} permettent d'ajouter ou de modifier les données contenues dans les entités.
        \end{paragraphe}
        
        \begin{paragraphe}
            \textbf{Les pages actions} permettent d'effectuer des vérifications, des validations et d'exécuter les actions souhaitées.
        \end{paragraphe}
		...
		\subsubsection{Page d'administration accueil}
			...
			\begin{paragraphe}
                Étant donné que l'ajout des genres et des récompenses se font respectivement sur les pages << musique >> et << artiste>>, nous avons
                 supprimer les deux boutons d'ajout du genre et de récompense et ajouter un bouton pour la gestion des récompenses.
			\end{paragraphe}
			...
			\begin{paragraphe}
				...
				Initialement cette page contient siex boutons :
				\begin{itemize}
        ...
        \clearpage
            ...
            \begin{paragraphe}
                \textbf{Voici le Mockup de conception :}
            \end{paragraphe}

			\image{0.35}{page_admin_index}{Mockup - Page d'administration accueil}
            
            \begin{paragraphe}
                \textbf{Voici le nouveau d'administration final qui ressemble beaucoup au Mockup:}
            \end{paragraphe}
    ...
    \clearpage
		...
		\subsubsection{Page gestion artiste}
            ...
            \begin{paragraphe}
                La gestion des artistes se fait sur trois pages, une page de gestion, une page formulaire et une page d'action.
            \end{paragraphe}
			...
			\begin{paragraphe}
                La page de gestion et la page formulaire apellent des fonctions à effectuer sur la page action.
			\end{paragraphe}

			\begin{paragraphe}
                \textbf{Voici donc la liste des actions possibles qu'effectue la page \underline{actionArtiste.php} :}
            
                \begin{itemize}
                    \item \emph{ajouter\_artiste(artiste)} :
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correctes. Le nom, le prénom et la date de naissance de l'artiste étant obligatoire.
            ...
            \begin{center}
                ...
                \begin{tabular}{l}
                    ...
                    \textbf{Alors} effectue l'action \emph{supprimerArtiste(artiste)}.
                \end{tabular}
            \end{center}
    ...
    \clearpage
		...
		\subsubsection{Page gestion groupe}
			...
			\begin{paragraphe}
                \textbf{Voici donc la liste des actions possibles qu'effectue la page \underline{actionGroupe.php} :}
            
                \begin{itemize}
                    \item \emph{ajouter\_groupe(groupe)} :
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correctes. Le nom, la date de création du groupe sont obligatoire.
                    De plus il est obligatoire de sélectionner deux artistes au minimum. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseignées sont correcte. Le nom, la date de création du groupe sont obligatoire.
                     De plus il est obligatoire de sélectionner deux artistes au minimum. Modifie ensuite les informations dans la base de données.
                \end{paragraphe}
    ...
    \newpage
		...
		\subsubsection{Page gestion album}
			...
			\begin{paragraphe}
                La page gestion reprend le même principe que précédement. Nous avons également rajouté des pages pour associer des musiques à un album.
			\end{paragraphe}
			...
			\begin{paragraphe}
                ...
                \end{itemize}
                \begin{paragraphe}
                    Permet de vérifier si les informations renseigner sont correcte. Le nom, la date de création de l'album sont obligatoire.
                     De plus, il est obligatoire de sélectionner un artiste ou un groupe de musique au minimum. Ajoute ensuite les informations dans la base de données.
                \end{paragraphe}
                ...
                \begin{paragraphe}
                    Permet de vérifier si les informations renseigner sont correcte. Le nom, la date de création de l'album sont obligatoire.
                     De plus, il est obligatoire de sélectionner un artiste ou un groupe de musique au minimum. Modifie ensuite les informations dans la base de données.
                \end{paragraphe}
