...
\section{Présentation}
	\subsection{Disposition 1 (layout)}
		...
		\begin{paragraphe}
			Ceci est la première disposition dont toutes les pages vont hériter. Ici c'est la disposition où l'utilisateur n'est pas connecté.
		\end{paragraphe}
	...
	\subsection{Disposition 2 (layout)}
		...
		\begin{paragraphe}
			Ceci est la seconde disposition dont toutes les pages vont hériter. Ici c'est la disposition où l'utilisateur normal est connecté.
		\end{paragraphe}
	...
	\subsection{Disposition 3 (layout)}
		...
		\begin{paragraphe}
			Ceci est la troisième disposition dont toutes les pages vont hériter. Ici c'est la disposition où l'utilisateur administrateur est connecté.
		\end{paragraphe}
