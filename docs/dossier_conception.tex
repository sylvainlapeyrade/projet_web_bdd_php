    ...
    \subsection{Pages publiques}
		...
		\subsubsection{Page description artiste/groupe}
         ...
         \newpage
            ...
            \end{paragraphe}
            \image{0.35}{images/conception/page_artiste_finale}{Pages publiques - Page artiste finale}

           \begin{paragraphe}
                Voici un autre exemple pour un groupe:
            \end{paragraphe}
            \image{0.35}{images/conception/page_groupe_finale}{Pages publiques - Page groupe finale}
		...
		\subsubsection{Page description album/musique}
           ...
           \newpage
            ...
            \end{paragraphe}
            \image{0.35}{images/conception/page_album_deconnecte}{Pages publiques - Page album non connecté finale}
          ...
          \newpage
           ...
           \begin{paragraphe}
            ...
            \end{paragraphe}
            \image{0.35}{images/conception/page_album_connecte}{Pages publiques - Page album connecté finale}
	...
	\subsection{Pages utilisateurs}
      \begin{paragraphe}
		...
		\subsubsection{Page de connexion}
			...
			\begin{paragraphe}
			    Cette page utilise intéragie avec la base de données avec la fonction:
				\begin{itemize}
			...
			\begin{paragraphe}
				...
				Alors initialement la page est constituée d'un simple formulaire non rempli avec trois champs, nom utilisateur, mot de passe et vérification mot de passe.\\
				 Il y également un bouton pour se connecter. Ainsi qu'un lien redirigeant vers la page d'inscription intitulé << s'inscrire >>.
			\end{paragraphe}
        ...
        \newpage
            \begin{paragraphe}
                La page finale correspond une nouvelle fois à la page imaginée lors de la conception, nous avons toutefois introduit le champ
                de vérification du mot de passse ainsi que le lien << s'inscrire >> auxquels nous n'avions pas pensé.
            \end{paragraphe}

            \image{0.60}{images/conception/page_connexion_finale}{Pages Utilisateurs - Page connexion finale}
