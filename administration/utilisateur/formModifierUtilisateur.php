    ...
    <section>
        ...
        <div>
            ...
            <div class="text-center">
                ...
                <form class="flex flex-center flex-column " action="./formModifierUtilisateur.php" method="get">
                    <input class="input-text" type="text" title="idUtilisateur" value="<?php echo $utilisateur['idutilisateur'] ?>" disabled>
