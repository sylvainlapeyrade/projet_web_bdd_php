...
CREATE TABLE Album(
  idAlbum	              INT	          CONSTRAINT Al_pk_idAl  PRIMARY KEY,
...
CREATE TABLE Artiste(
	idArtiste             INT           CONSTRAINT Ar_pk_idAr  PRIMARY KEY,
...
CREATE TABLE Recompense(
	idRecompense 	        INT   		    CONSTRAINT Re_pk_idRe  PRIMARY KEY,
...
CREATE TABLE Musique(
	idMusique             INT		        CONSTRAINT Mu_pk_idMu  PRIMARY KEY,
...
CREATE TABLE Groupe(
	idGroupe              INT            CONSTRAINT Gr_pk_idGr  PRIMARY KEY,
