                    ...
                    <?php foreach($listeArtistesRecherche as $artiste) { ?>
                        <div class="flex">
                            ...
                            <div class="information-recherche">
                                ...
                                <a id="boutton-voir-plus" class="button button-red1" href="/artiste.php?idArtiste=<?php echo $artiste['idartiste']; ?>">Voir les détails</a>
                            </div>
                        </div>
                        <hr color="white" size="1">
                    <?php } ?>
                    ...
                    <?php foreach($listeGroupesRecherche as $groupes) { ?>
                        <div class="flex">
                            ...
                            <div class="information-recherche">
                                ...
                                <a id="boutton-voir-plus" class="button button-red1" href="/groupe.php?idGroupe=<?php echo $groupes['idgroupe']; ?>">Voir les détails</a>
                            </div>
                        </div>
                        <hr color="white" size="1">
                    <?php } ?>
                    ...
                    <?php foreach($listeAlbumsRecherche as $album) { ?>
                        <div class="flex">
                            ...
                            <div class="information-recherche">
                                ...
                                <br>
                                <a id="boutton-voir-plus" class="button button-red1" href="/album.php?idAlbum=<?php echo $album['idalbum']; ?>">Voir les détails</a>
                            </div>
                        </div>
                        <hr color="white" size="1">
                    <?php } ?>
                ...
                <div>
                    ...
                    <?php foreach($listeMusiquesRecherche as $musique) { ?>
                        <div class="information-recherche">
                            ...
                            <a id="boutton-voir-plus" class="button button-red1" href="/artiste.php?idArtiste=<?php echo $musique['idartiste']; ?>">Voir les détails</a>
                        </div>
                        <hr color="white" size="1">
                    <?php } ?>
                </div>
